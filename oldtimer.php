...
<div id="countbox1" style="font:18pt Arial; color:#ffffff; text-align:center; height: 300px; position: relative; top: 50%; transform: translateY(50%);"></div>
<div style="text-align: center; position: relative; top: 50%; transform: translateY(200%);">
